...
Page({
  ...
  formSubmit: function (e) {
    ...
    var ifCar = true;
    var ifAddress=true;
    edit.editSubmit(e, that, this.data.listId, this.data.sessionId, 'trailer', ifCar, 4, ifAddress)
  },
  ...
  onShow: function () {
    ...
    edit.editShow(that, this.data.sessionId, 'trailer', 4, that.data.listId)
