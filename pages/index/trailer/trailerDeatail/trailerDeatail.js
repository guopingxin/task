...
Page({
  ...
  orders: function () {
    var that = this;
    detail.orders(that, 'trailer')
  },
  finish: function () {
    detail.finish(this, 'trailer')
  },
  tocarTrace: function () {
    wx.navigateTo({
      url: '../../carTrace/carTrace?modulsis=4&&list=' + this.data.listId,
    })
  },
  toAddProgress: function () {
    wx.navigateTo({
      url: '../../addProgress/addProgress?moduleis=3&&detailId=' + this.data.detailId,
    })
  },
  onHide: function () {
